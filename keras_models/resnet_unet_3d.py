...
def get_unet(input_shape, n_classes=1):
    inputs = Input(input_shape, n_classes)
    ...
    up6 = concatenate(
        [
            Conv3DTranspose(256, (2, 2, 2), strides=(2, 2, 2), padding="same")(conc5),
            conv4,
        ],
        axis=4,
    )
    ...
    up7 = concatenate(
        [
            Conv3DTranspose(128, (2, 2, 2), strides=(2, 2, 2), padding="same")(conc6),
            conv3,
        ],
        axis=4,
    )
    ...
    up8 = concatenate(
        [
            Conv3DTranspose(64, (2, 2, 2), strides=(2, 2, 2), padding="same")(conc7),
            conv2,
        ],
        axis=4,
    )
    ...
    up9 = concatenate(
        [
            Conv3DTranspose(32, (2, 2, 2), strides=(2, 2, 2), padding="same")(conc8),
            conv1,
        ],
        axis=4,
    )
