...
def Attention_ResUNet_3D(input_shape, n_classes_1=1, n_classes_2 = 1, dropout_rate=0.2, batch_norm=True):
    FILTER_NUM = 16
    FILTER_SIZE = 3
    UP_SAMP_SIZE = 2
    ...
    up_32 = layers.UpSampling3D(size=(UP_SAMP_SIZE, UP_SAMP_SIZE, UP_SAMP_SIZE))(up_conv_16)
    ...
    up_64 = layers.UpSampling3D(size=(UP_SAMP_SIZE, UP_SAMP_SIZE, UP_SAMP_SIZE))(up_conv_32)
    ...
    up_128 = layers.UpSampling3D(size=(UP_SAMP_SIZE, UP_SAMP_SIZE, UP_SAMP_SIZE))(up_conv_64)
    ...
    conv_final = layers.Conv3D(n_classes_1, kernel_size=(1, 1, 1))(up_conv_128)
    conv_final = layers.BatchNormalization(axis=axis)(conv_final)
    output_1 = layers.Activation(activation)(conv_final)

    ## DECODER 2
    gating_16_2 = gating_signal_3d(conv_8, 8 * FILTER_NUM, batch_norm)
    att_16_2 = attention_block_3d(conv_16, gating_16_2, 8 * FILTER_NUM)
    up_16_2 = layers.UpSampling3D(size=(UP_SAMP_SIZE, UP_SAMP_SIZE, UP_SAMP_SIZE))(conv_8)
    up_16_2 = layers.concatenate([up_16_2, att_16_2], axis=axis)
    up_conv_16_2 = res_conv_block_3d(up_16_2, FILTER_SIZE, 8 * FILTER_NUM, dropout_rate, batch_norm)
    ...
    up_32_2 = layers.UpSampling3D(size=(UP_SAMP_SIZE, UP_SAMP_SIZE, UP_SAMP_SIZE))(up_conv_16_2)
    up_32_2 = layers.concatenate([up_32_2, att_32_2], axis=axis)
    up_conv_32_2 = res_conv_block_3d(up_32_2, FILTER_SIZE, 4 * FILTER_NUM, dropout_rate, batch_norm)
    ...
    up_64_2 = layers.UpSampling3D(size=(UP_SAMP_SIZE, UP_SAMP_SIZE, UP_SAMP_SIZE))(up_conv_32_2)
    up_64_2 = layers.concatenate([up_64_2, att_64_2], axis=axis)
    up_conv_64_2 = res_conv_block_3d(up_64_2, FILTER_SIZE, 2 * FILTER_NUM, dropout_rate, batch_norm)
    ...
    up_128_2 = layers.UpSampling3D(size=(UP_SAMP_SIZE, UP_SAMP_SIZE, UP_SAMP_SIZE))(up_conv_64_2)
    up_128_2 = layers.concatenate([up_128_2, att_128_2], axis=axis)
    up_conv_128_2 = res_conv_block_3d(up_128_2, FILTER_SIZE, FILTER_NUM, dropout_rate, batch_norm)

    
    conv_final_2 = layers.Conv3D(3, kernel_size=(1, 1, 1))(up_conv_128_2)
    conv_final_2 = layers.BatchNormalization(axis=axis)(conv_final_2)
    output_2 = layers.Activation("tanh")(conv_final_2)
