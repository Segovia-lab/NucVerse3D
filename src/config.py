...
STEP_SIZE_PREDICTION = (48, 96, 96)  # Step size for prediction patch generation
...
TEST_SIZE = 0.1  # Test size for train/validation split
...
PREDICTION_BATCH_SIZE = 2  # Batch size for prediction
