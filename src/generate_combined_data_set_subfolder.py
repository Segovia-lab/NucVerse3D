...
#python src/generate_combined_data_set_subfolder.py  split-dataset data/interim/1_c_elegans_nuclei/ -d c_elegans -n 1000 --seed 42 --no-scale
#python src/generate_combined_data_set_subfolder.py  split-dataset data/interim/2_livernuclei/ -d liver_nuclei -n 1000 --seed 42 --no-scale
#python src/generate_combined_data_set_subfolder.py  split-dataset data/interim/3_mesoSPIM_dataset/ -d mesoSPIM_dataset -n 1000 --seed 42 --no-scale
#python src/generate_combined_data_set_subfolder.py  split-dataset data/interim/4_Mouse_NucMM-M/ -d mouse -n 1000 --seed 42 --no-scale
#python src/generate_combined_data_set_subfolder.py  split-dataset data/interim/5_Zebrafish_NucMM-Z/ -d zebrafish -n 1000 --seed 42 --no-scale
#python src/generate_combined_data_set_subfolder.py  split-dataset data/interim/6_Drosophila_denoised/ -d drosophila-denoised -n 1000 --seed 42 --no-scale
#python src/generate_combined_data_set_subfolder.py  split-dataset data/7_liver_hcc_dataset/ -d liver_hcc -n 1000 --seed 42 --no-scale
