...
from preprocessing.image_preprocessing import preprocessing, preprocessing_simple
...
def _build_patches_for_split(
    ...
    if config.PREPROCESSING_ENABLED:
        ...
        images_padded = [preprocessing_simple(_pad_to_minimum(img, patch_size)) for img in images ]
